...
const NavigationPlaceholder = ({ book, chapter, getBookName, onNavigate }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center bg-gray-100 px-5 py-3 rounded-md text-gray-700 text-xl">
        <span>Primary Reading:</span>
        <span className="font-medium mx-2">{book.book || getBookName(book.abbrev)}</span>
        <ChevronRight className="h-6 w-6 mx-1" />
      ...
      {showHistory && navigationHistory.length > 0 && (
        <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-md shadow-lg z-10">
          <div className="p-4 border-b border-gray-200">
            <h3 className="font-medium text-xl">Reading History</h3>
          </div>
          <div className="max-h-80 overflow-y-auto">
            {[...navigationHistory].reverse().map((item, index) => (
              <button
                ...
                className="w-full text-left px-5 py-3 hover:bg-gray-100 flex items-center justify-between text-xl"
              >
                <span>
        ...
        <div className="overflow-y-auto h-full">
          {bibleData && bibleData.map(book => (
            <button
              ...
              className={`w-full text-left px-6 py-4 hover:bg-gray-100 text-xl ${
            ...
            <div className="flex flex-wrap items-center justify-between">
              <div className="flex items-center">
                ...
                {selectedBook && (
                  <div className="flex items-center ml-5">
                    <span className="mr-2 text-2xl">Chapter:</span>
                    <select 
              ...
              <div className="flex items-center mt-2 sm:mt-0">
                <div className="flex items-center">
                  ...
                  <span className="mr-2 text-2xl">Translation:</span>
                  <select 
                    value={selectedTranslation}
                    onChange={handleTranslationChange}
                    className="border border-gray-300 rounded px-4 py-2 text-2xl bg-white"
                  >
            ...
            <div className="flex items-center space-x-2">
              ...
              {isViewingCrossRef && (
                <button
                  ...
                  className="px-5 py-2 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition-colors text-xl"
                >
