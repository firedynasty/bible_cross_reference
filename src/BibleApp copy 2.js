...
const NavigationPlaceholder = ({ book, chapter, getBookName, onNavigate }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center bg-gray-100 px-2 py-0.5 rounded-md text-gray-700 text-sm">
        <span>Primary:</span>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between">
              <div className="flex items-center">
                ...
                {selectedBook && (
                  <div className="flex items-center ml-2">
                    <span className="mr-1 text-sm">Chapter:</span>
                    <select 
              ...
              <div className="flex items-center mt-1 sm:mt-0">
                <div className="flex items-center">
                  ...
                  <span className="mr-1 text-sm">Translation:</span>
                  <select 
        ...
        <div className="flex-1 flex overflow-hidden">
            ...
            {selectedBook && selectedChapter > 0 && (
              <div>
                <h2 className="text-base font-semibold flex items-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-book-open mr-1 h-4 w-4">
          ...
          <div className="w-96 border-l border-gray-200 bg-gray-50 flex flex-col">
            <div className="overflow-auto p-2 border-b border-gray-200">
              <h2 className="text-base font-semibold flex items-center">
            ...
            <div ref={kjvContentRef} className="flex-1 p-4 overflow-y-auto bg-white">
              {selectedBook && selectedChapter > 0 && (
                <div>
                  <h2 className="text-base mr-2 font-semibold mb-4">
                    {selectedBook.book || getBookName(selectedBook.abbrev)} {selectedChapter}
                  </h2>
                  <div className="space-y-2">
