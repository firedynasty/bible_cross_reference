...
const NavigationPlaceholder = ({ book, chapter, getBookName, onNavigate }) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center bg-gray-100 px-4 py-2 rounded-md text-gray-700 text-lg">
        <span>Primary Reading:</span>
        <span className="font-medium mx-2">{book.book || getBookName(book.abbrev)}</span>
          ...
          <div className="max-h-72 overflow-y-auto">
            {[...navigationHistory].reverse().map((item, index) => (
              <button
                ...
                className="w-full text-left px-4 py-3 hover:bg-gray-100 flex items-center justify-between text-lg"
              >
                <span>
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100">
        <div className="text-center">
          <div className="text-3xl font-bold mb-4">Loading Bible Data...</div>
          <div className="animate-pulse bg-blue-500 h-3 w-80 rounded"></div>
        </div>
      </div>
    );
  }
    ...
    <div className="flex h-screen bg-gray-100">
        ...
        <div className="overflow-y-auto h-full">
          {bibleData && bibleData.map(book => (
            <button
              ...
              className={`w-full text-left px-6 py-3 hover:bg-gray-100 text-lg ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between">
              <div className="flex items-center">
                ...
                {selectedBook && (
                  <div className="flex items-center ml-4">
                    <span className="mr-2 text-xl">Chapter:</span>
                    <select 
                      value={selectedChapter}
                      onChange={(e) => handleChapterSelect(parseInt(e.target.value))}
                      className="border border-gray-300 rounded px-3 py-2 text-xl"
                    >
              ...
              <div className="flex items-center mt-2 sm:mt-0">
                <div className="flex items-center">
                  ...
                  <span className="mr-2 text-xl">Translation:</span>
                  <select 
                    value={selectedTranslation}
                    onChange={handleTranslationChange}
                    className="border border-gray-300 rounded px-3 py-2 text-xl bg-white"
                  >
            ...
            <div className="flex items-center space-x-2">
              ...
              {isViewingCrossRef && (
                <button
                  ...
                  className="px-4 py-2 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition-colors text-lg"
                >
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Bible Text Display */}
          <div ref={chapterContentRef} className="w-1/2 overflow-y-auto p-6 bg-white relative">
            {selectedBook && selectedChapter > 0 && (
              <div>
                <h2 className="text-2xl font-semibold flex items-center mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-book-open mr-2 h-6 w-6">
                  ...
                  {selectedBook.chapters[selectedChapter - 1].map((verse, index) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`leading-relaxed p-3 rounded-md transition-colors text-xl ${
                          hasReference ? 'hover:bg-blue-50' : ''
                        }`}
                      >
                        <p className="flex">
                          <span className="font-bold text-blue-600 mr-3 text-xl">{verseNumber}</span>
                        ...
                        {showCrossRef === refKey && (
                          <div className="mt-3 p-4 bg-blue-50 border border-blue-200 rounded-md shadow-sm">
                            <h4 className="font-medium mb-3 text-xl">Cross References:</h4>
                ...
                <div className="mt-8 flex justify-between pb-4">
                  {selectedChapter > 1 ? (
                    <button 
                      ...
                      className="bg-white bg-opacity-80 border border-gray-300 hover:bg-gray-100 text-gray-700 font-bold rounded px-6 py-3 shadow text-lg"
                    >
                      &lt; Previous Chapter
                    </button>
                  ) : (
          ...
          <div className="w-1/2 border-l border-gray-200 bg-gray-50 flex flex-col">
            <div className="overflow-auto p-4 border-b border-gray-200">
              <h2 className="text-2xl font-semibold flex items-center">
            ...
            <div ref={kjvContentRef} className="flex-1 p-6 overflow-y-auto bg-white">
              {selectedBook && selectedChapter > 0 && (
                <div>
                  <h2 className="text-2xl mr-2 font-semibold mb-4">
                    {selectedBook.book || getBookName(selectedBook.abbrev)} {selectedChapter}
                  </h2>
                  <div className="space-y-4">
                    {kjvBibleData && selectedBook && kjvBibleData.find(b => b.abbrev === selectedBook.abbrev)?.chapters[selectedChapter - 1].map((verse, index) => {
                      ...
                      return (
                        ...
                        >
                          <p className="flex">
                            <span className="font-bold text-blue-600 mr-3">{verseNumber}</span>
                            <span className="flex-1">{verse}</span>
                          </p>
                        </div>
                      );
